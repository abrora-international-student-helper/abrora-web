...
export default function HomePage() {
  return (
    <div className="h-screen overflow-y-auto scroll-smooth snap-y snap-proximity bg-white text-gray-900">
      {/* Hero Section */}
      <section className="relative overflow-hidden snap-start min-h-screen">
        {/* soft blobs */}
